...
Nom de l'établissement : Adresse :N° de téléphone : Propriétaire : Exploitant :  I. - Installation de l'équipement et matériel
...
(A prévoir pour les différents types d'accidents

et en fonction des personnels présents alors dans l'établissement)
