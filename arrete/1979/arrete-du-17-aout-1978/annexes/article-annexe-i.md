...
Programme des connaissances de l'épreuve théorique de l'examen du brevet de pilote de planeur
...
La résistance de l'air mise en évidence, effets produits sur le déplacement d'un corps en fonction de sa forme ;

Principe de sustentation de l'aile: écoulement de l'air autour du profil, angle d'incidence, forces aérodynamiques (résultante, portance, traînée), notion de finesse aérodynamique, centre de poussée ;
...
Masse et poids, notion de centre de gravité, positionnement du centre de gravité;
...
Action des forces appliquées au planeur dans les cas de vol suivants :
...
Critères pour l'air saturé et non saturé.

Notions sur l'instabilité conditionnelle et convective.

2.3.2. Convection thermique :

Mécanisme de formation ;

Formation et évolution des ascendances et des cumulus ;
...
Notions sur les services de la circulation aérienne ; les fonctions assurées (contrôles, information de vol, alerte) et les organismes concernés ;
...
Lecture et utilisation de la carte en vol.
