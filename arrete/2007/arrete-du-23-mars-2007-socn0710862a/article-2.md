...
Cette liste est transférée, via le réseau sécurisé administration en réseau (AdER), sur un serveur Unédic sous un protocole de cryptage avec authentification par login et mot de passe du responsable de ce transfert.
