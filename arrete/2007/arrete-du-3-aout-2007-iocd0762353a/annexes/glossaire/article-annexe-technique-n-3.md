# Article Annexe technique n° 3

Définition de quelques termes techniques utilisés fréquemment en matière de vidéoprotection.
...
Bande passante (réseau) : dans le domaine de l'informatique, le terme bande passante désigne un débit d'informations, plus précisément la quantité d'informations que peut transmettre un réseau (système informatique). Cette bande passante ce mesure généralement en octets par seconde ou en bits par seconde.
...
Format CIF (4 CIF) : Common Intermediate Format. Le format CIF est un format numérique d'images de 352 x 288 pixels. Le format 4 CIF évoqué dans cette circulaire est le format d'image standard de 704 x 576 pixels.
...
Système numérique : la notion de système numérique, dans le contexte de l'arrêté, s'applique exclusivement aux modules de stockage. Ainsi un système composé de caméras analogiques, mais avec un module de stockage numérique, sera considéré comme un système numérique de vidéoprotection.

Système analogique : la notion de système analogique, dans le contexte de l'arrêté, s'applique exclusivement aux modules de stockage. Sur une installation de vidéoprotection, si le module de stockage est analogique, alors le système de vidéoprotection sera donc considéré comme analogique. On étendra cette catégorie aux systèmes de vidéoprotection de moins de huit caméras équipés de modules de stockage numérique, mais dont les fonctionnalités se limitent à celles d'un module de stockage analogique.
