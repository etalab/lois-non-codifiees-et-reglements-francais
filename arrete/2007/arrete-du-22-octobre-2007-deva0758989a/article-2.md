...
Peuvent être prises en compte dans le calcul des quatre années mentionnées au premier alinéa du présent article, jusqu'au 31 décembre 2006, les fonctions suivantes :

- directeur d'aérodrome ;

- adjoint au directeur d'aérodrome ;

- chef d'équipe DS4 au service central des télécommunications ;

- chef d'équipe coordination automatique du trafic aérien (CAUTRA).
