...
- palier à 0,5 U dim pendant les 450 ms suivantes ;

- retour linéaire à 0,9 U dim pendant les 400 ms suivantes ;

- palier à 0,9 U dim pendant les 400 ms suivantes ;

- retour linéaire à U dim pendant les 500 ms suivantes.

2. Installation raccordée au réseau d'interconnexion :

- creux de tension 100 % pendant 150 ms ;

- palier à 0,5 U dim pendant les 550 ms suivantes ;

- retour linéaire à U dim pendant les 800 ms suivantes.
