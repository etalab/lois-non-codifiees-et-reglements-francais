...
l'adresse de messagerie électronique de l'émetteur du message, les dates et heures d'émission et de réception, l'objet et le contenu du message, l'identité du visiteur (nom, prénoms, sexe) ;

- pour la mise à disposition d'informations pratiques :

historique, situation géographique, unités, guide d'accueil, organisation, prévention, ressources humaines, équipements, culture et patrimoine, actualités, recrutement, réserve, missions, magazines, brèves ;

- pour le recueil de données relatives aux consultations :

estimation de la fréquentation du site par le biais d'un compteur à des fins statistiques.
