...
- un numéro de liaison séquentiel transmis par les CPR-SNCF ;

- le numéro SIRET de l'organisme demandeur.

Sur la base des réponses transmises par la DGI, les informations gérées dans le système de gestion des pensions des CPR-SNCF sont mises à jour.

Les destinataires des informations sont les agents habilités du service gestionnaire des pensions des CPR-SNCF.
...
Sur la base des réponses transmises par la DGI, les informations gérées dans le système de gestion des pensions de l'ENIM sont mises à jour.
