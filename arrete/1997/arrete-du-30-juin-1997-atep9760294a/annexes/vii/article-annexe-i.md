...
La quantité de déchets stockés sur le site ne doit pas dépasser la capacité mensuelle produite ou un lot normal d'expédition vers l'installation d'élimination sauf en cas de recyclage, interne à l'installation.
...
L'exploitant doit être en mesure d'en justifier l'élimination ; les documents justificatifs doivent être conservés 3 ans.
