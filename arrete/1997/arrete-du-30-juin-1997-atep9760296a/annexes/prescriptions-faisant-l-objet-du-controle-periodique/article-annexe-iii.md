...
- présence des résultats des mesures faites par  un organisme agréé ou évaluation des capacités des équipements d'épuration à  respecter les valeurs limites d'émission applicables ;

- conformité des  résultats de mesures avec les valeurs limites d'émission applicables ;

-  présence des mesures ou d'évaluation du débit si celui-ci est supérieur à 10  mètres cubes jour.
