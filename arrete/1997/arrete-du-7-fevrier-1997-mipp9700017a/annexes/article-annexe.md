...
Permanence, qualité, disponibilité
...
L'ensemble des dispositions spécifiques prises par l'opérateur à la demande de l'Etat fait l'objet d'une convention avec l'Etat qui garantit une juste rémunération de l'opérateur pour les études, l'ingénierie, la conception, le déploiement et l'exploitation des systèmes demandés.
...
8.1.1. Fréquences utilisables pour l'établissement

de liaisons fixes autres que les liaisons satellites

L'opérateur peut établir des liaisons hertziennes pour l'infrastructure fixe de son réseau après accord préalable de l'Autorité de régulation des communications électroniques et des postes. Ces liaisons et leurs caractéristiques sont portées au CCTP.

Les conditions d'établissement et d'exploitation de ces liaisons sont précisées au CCTP.

8.1.2. Bandes de fréquences utilisées par les stations terriennes

Les stations terriennes du réseau utilisent les bandes de fréquences suivantes attribuées exclusivement au service fixe par satellite :

14,00-14,25 GHz pour les liaisons montantes ;

12,50-12,75 GHz pour les liaisons descendantes.

Le cas échéant, le titulaire peut être autorisé par l'Autorité de régulation des communications électroniques et des postes à utiliser d'autres bandes de fréquences du service fixe par satellite sous réserve que toutes les stations du réseau présentant des fonctions d'émission dans ces bandes fassent obligatoirement l'objet d'une procédure préalable de coordinations techniques avant leur mise en service conformément au paragraphe 8.2 du présent cahier des charges.

8.2. Coordination des stations terriennes du réseau

Les coordinations ont pour objet de vérifier pour une station terrienne, préalablement à sa mise en service, sa compatibilité sur le plan radioélectrique avec les autres services existants ou planifiés utilisant les mêmes bandes de fréquences.

Toute station terrienne implantée dans le cadre du réseau autorisé et présentant des émissions sur des fréquences autres que celles de la bande 14,00-14,25 GHz doit faire l'objet d'une coordination technique et d'un accord pour l'usage de ces fréquences, préalablement à sa mise en service.

Les stations terriennes utilisant en réception des fréquences dans les bandes de fréquences autres que la bande 12,50-12,75 GHz et qui n'ont pas fait l'objet d'une coordination pour l'utilisation de ces fréquences ne pourront prétendre à aucune protection contre d'éventuelles perturbations radioélectriques dues à d'autres services fonctionnant dans la même bande de fréquences.

Les demandes de coordinations techniques sont à adresser à l'Autorité de régulation des communications électroniques et des postes selon les modalités définies au CCTP.
...
8.4.1. Redevances pour les liaisons satellites

Le titulaire est assujetti à une redevance annuelle de gestion des fréquences radioélectriques de 100 000 F.

L'opérateur est assujetti également à une redevance annuelle et forfaitaire pour mise à disposition de fréquences radioélectriques de 100 F par station d'émission.

Les stations terriennes de réception uniquement ne sont pas soumises à la redevance pour mise à disposition de fréquences radioélectriques définie à l'alinéa précédent.

8.4.2. Redevances pour mise à disposition

des fréquences radioélectriques autres que satellites

L'opérateur titulaire de l'autorisation acquitte au budget de l'Etat des redevances, conformément aux dispositions prévues par le décret du 3 février 1993 modifié relatif aux redevances de mise à disposition de fréquences radioélectriques dues par les titulaires des autorisations délivrées en application des articles L. 33-1 et L. 33-2 du code des postes et des télécommunications.
...
Les ressources en numérotation sont attribuées, sur demande de l'opérateur, par l'Autorité de régulation des communications électroniques et des postes.

L'opérateur peut se servir des numéros qui lui sont attribués pour son usage ou les affecter à des utilisateurs finaux dans le cadre de relations contractuelles. L'utilisateur final peut être un prestataire de services.

L'opérateur peut demander une attribution de :

- numéros géographiques avec Z = 3 ;
...
Les opérateurs prévoient les conditions nécessaires à la portabilité des numéros dans les conventions d'interconnexion définies au
...
L'opérateur doit acquitter les redevances dues pour les ressources en numérotation attribuées conformément aux textes en vigueur. Il est soumis aux dispositions relatives à la numérotation du décret prévu à l'article L. 34-10 de la loi de réglementation des télécommunications dès sa publication.
