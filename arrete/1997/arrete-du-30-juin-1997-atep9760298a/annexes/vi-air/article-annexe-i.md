...
a) La hauteur minimale de la ou des cheminées doit être au moins égale à : 80 q1/2 (R DeltaT)- 1/6 avec :

- q : débit maximal de poussières exprimé en kilogrammes par heure rejeté par l'ensemble des cheminées ;

- R : débit de gaz rejeté exprimé en mètres cubes par heure à la température effective d'éjection des gaz ;
...
A défaut de méthode spécifique normalisée et lorsque les composées sont sous forme particulaire ou vésiculaire, les conditions d'échantillonnage isocinétique décrites par la norme NFX 44.052 doivent être respectées.
