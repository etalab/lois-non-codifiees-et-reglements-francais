...
Visibilité horizontale : visibilité dans le plan horizontal mesurée par les services compétents selon des techniques spécifiées :

elle peut correspondre à la visibilité météorologique (VIS) ou à la portée visuelle de piste (RVR) mesurée de façon instrumentale ou par observation directe (VIBAL) ou selon une technique soumise à approbation (PVA).
