...
Les effluents gazeux ne doivent pas contenir plus de 150 milligrammes/Nm3 de poussières, exprimées dans les conditions normalisées de température (273 kelvins) et de pression (101,3 kilos/pascals) après déduction de la vapeur d'eau (gaz sec) et mesurées selon les méthodes définies au point 6.3.

Le point de rejet doit dépasser d'au moins trois mètres les bâtiments situés dans un rayon de 15 mètres.
