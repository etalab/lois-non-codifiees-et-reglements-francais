...
Titulaire de l'autorisation : France Télécom radio professionnelle
...
Le service offert à des tiers utilisateurs par l'exploitant consiste en la possibilité de raccordement à son réseau de stations radio-électriques privées (fixes, mobiles et portatives) exploitées par ces tiers utilisateurs, dans le but d'établir, dans la zone de couverture radioélectrique du système, des communications à caractère professionnel, internes aux groupes fermés d'abonnés qu'ils constituent.
