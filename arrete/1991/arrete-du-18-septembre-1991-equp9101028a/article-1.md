...
L'examen d'aptitude technique spéciale pour l'admission aux emplois réservés de dessinateur (service de l'équipement) comporte trois épreuves écrites d'admission et une épreuve écrite facultative.

Epreuve no 1 analyse de texte (durée deux heures; coefficient 1).
...
Epreuve no 2 mathématiques appliquées (durée deux heures; coefficient 2). Séries d'exercices portant sur le programme figurant en annexe (1).
...
Epreuve no 3 dessin (épreuve optionnelle) (durée quatre heures;

coefficient 4).

Report à une échelle donnée, selon les indications figurant en annexe, de tout ou partie d'un ou plusieurs plans. Des croquis ou schémas pourront être demandés aux candidats.
...
Epreuve no 4: épreuve écrite facultative portant sur le traitement automatisé de l'information (durée: une heure; coefficient 1).
