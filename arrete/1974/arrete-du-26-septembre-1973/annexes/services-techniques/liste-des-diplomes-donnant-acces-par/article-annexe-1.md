...
Exécution de travaux (bâtiments et travaux publics).
...
Hôtellerie (option Cuisine restaurant).
...
Assistant ou assistante technique d'ingénieur.
...
Gestion des hôtels et des restaurants (option gestion d'entreprise de restauration collective).

Mécanique automatisme.

Métiers du bâtiment (couverture, plomberie et installation sanitaires, installations thermiques).

Moteurs à combustion interne.

Physicien.

Production culinaire (option restauration et cuisine de collectivités).

Brevet de technicien supérieur délivré dans l'une des spécialités de brevet de technicien énumérées au I ci-dessus.
...
Constructions mécaniques (F 1).

Electronique (F 2).

Electrotechnique (F 3).
...
Microtechniques (option Appareillage) (F 10).
...
Agent de maintenance en matériel de traitement de l'informatique.

Agent technique électricien.

Agent technique sur machines électrocomptables.

Agent technique testeur en téléphonie.

Aptitude technique à la maîtrise (forges de Basse-Indre).

Chef adjoint de cuisine de collectivité.

Chef de chantier adjoint à conducteur de travaux.

Chef de chantier premier niveau gros oeuvre (perfectionnement d'ouvriers qualifiés).

Commis du bâtiment.

Comptable d'entreprise avec connaissance de la mécanographie et initiation à l'informatique.
...
Industrie du froid : agent technique.

Mécanique générale : aptitude technique à la maîtrise.

Mécanique générale : chef d'équipe.

Menuiserie bâtiment (commis métreur).

Opérateur pupitreur sur ordinateur.

Programmeur d'application.

Programmeur d'application sur calculatrice électronique.

Programmeur de gestion (adaptation, promotion).

Second, adjoint à chef de cuisine de collectivité.

Technicien d'étude en chauffage central.
...
Analyste programmeur (gros systèmes).

Analyste programmeur (petits et moyens systèmes).
...
Programmeur de gestion avec connaissance d'analyse.
...
Chaudronnier en alliages légers.

Chaudronnier en cuivre.

Chaudronnier en fer.

Chaudronnier en métaux inoxydables.
...
Mécanicien outilleur en moules métalliques métal.

Mécanicien outilleur en moules métalliques plastiques.
...
Modeleur mécanicien métal.

Monteur en ostéologie.
...
Brevet élémentaire de spécialiste en informatique.

Brevet élémentaire de spécialiste en programmation.

Brevet supérieur de chef commis aux vivres.

Brevet supérieur de chef cuisinier.

Brevet supérieur (électricité bord).

Brevet supérieur (électricité sol).

Brevet supérieur de mécanicien d'équipage.

Brevet supérieur de mécanique générale.
...
Brevet supérieur de charpentier.

Brevet supérieur de commis aux vivres.

Brevet supérieur d'électricien.

Brevet supérieur d'électricien d'armes.

Brevet supérieur d'électromécanicien de sécurité.

Brevet supérieur de fourrier.

Brevet supérieur de mécanicien d'aéronautique.
...
Chantiers d'engins du génie.

Electromécanicien auto, engins et génératrices.

Electromécanicien tourelles, engins blindés.
...
Mécanicien des matériels faisceaux hertziens et voies multiples.

Mécanicien de matériel radio.
...
Brevet supérieur d'électronicien d'aéronautique.
...
Analyse et programmation de centre automatisé.
...
L'institut d'enseignement supérieur de l'Etat, à Gembloux.

Les écoles techniques horticoles de Mariemont, à La Hestre.
...
Mention communication visuelle et audiovisuelle ; options Graphisme, Audiovisuel, Photo et Illustration.

Mention environnement : toutes les options.

Diplôme national des arts et techniques :

Mentions Cadre bâti et Arts graphiques.
...
Titre de technicien de génie rural du ministère de l'agriculture.
