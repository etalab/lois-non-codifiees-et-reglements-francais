...
Le titre professionnel de technicien(ne) d'exploitation et de maintenance de remontées mécaniques est créé (ancien intitulé : technicien d'exploitation de remontées mécaniques).
