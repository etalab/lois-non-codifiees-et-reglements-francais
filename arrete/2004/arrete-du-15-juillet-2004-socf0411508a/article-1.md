...
Le titre professionnel d'agent (e) d'exploitation et de maintenance de remontées mécaniques est créé (ancien intitulé : agent de maintenance de remontées mécaniques).
