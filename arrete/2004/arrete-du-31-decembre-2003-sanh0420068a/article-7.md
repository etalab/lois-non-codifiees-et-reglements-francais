...
Pour chaque établissement, le médecin chargé de l'information médicale sauvegarde le fichier de RSS qui est à la source du fichier de RSAc et assure la conservation de la copie produite.
...
En vue de la constitution de bases nationales de données, l'ARH transmet à l'agence technique de l'information sur l'hospitalisation (ATIH), au plus tard au 30 avril de l'année en cours, les fichiers constitués de l'ensemble des informations que lui ont transmises les établissements de santé de la région au titre de l'année civile précédente.
