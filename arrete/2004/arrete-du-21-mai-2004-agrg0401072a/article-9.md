...
1. 1. La commande des ensembles insert-injecteurs est réalisée exclusivement par un ayant droit. Cette commande est effectuée auprès d'un fabricant, distributeur ou importateur dont le matériel mis sur le marché a fait l'objet d'un agrément conformément à l'article 7 du présent arrêté.

1. 2. Le fabricant, distributeur ou importateur doit vérifier avant tout envoi du matériel que chaque commande d'ensemble insert-injecteurs est bien signée par un ayant droit.

1. 3. Le fabricant, distributeur ou importateur transmet au gestionnaire du marquage électronique, au plus tard sous huit jours après réception de la commande, les ensembles insert-injecteurs, la liste des numéros de marquage correspondant et le nom de l'ayant droit destinataire.
...
1. 4. Le gestionnaire du marquage électronique transmet les ensembles insert-injecteurs à l'ayant droit dans un délai de huit jours suivant leur réception. Dans le cas d'une constitution de stock tel que prévu au point ci-dessus, le gestionnaire du marquage électronique doit transmettre les ensembles insert-injecteurs dans les huit jours suivant la réception de la validation de la commande par le fabricant, distributeur ou importateur.

1. 5. Le gestionnaire du marquage électronique ne peut délivrer que des inserts ayant une date de péremption strictement supérieure à un an.
...
2. 1. La commande des documents de marquage est réalisée exclusivement par une personne habilitée auprès du gestionnaire du marquage électronique.

2. 2. Le gestionnaire du marquage électronique doit vérifier que toute commande est signée par une personne habilitée.

2. 3. Le gestionnaire du marquage électronique transmet les documents de marquage dans les huit jours suivant la réception de la commande.
