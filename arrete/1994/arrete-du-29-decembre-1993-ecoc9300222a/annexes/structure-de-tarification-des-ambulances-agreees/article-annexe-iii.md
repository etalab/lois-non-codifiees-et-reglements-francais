...
Le transport du malade ou du blessé jusqu'au lieu de destination ;    L'immobilisation du véhicule et de l'équipage forfaitairement au départ et à l'arrivée ;
...
Il s'applique à la distance parcourue en charge avec le malade ou le blessé du lieu de départ jusqu'au lieu d'arrivée, exprimée en kilomètres, déduction faite des 5 premiers kilomètres compris dans le minimum de perception ;
...
Il couvre toutes les prestations énumérées en A, sans aucun supplément, en particulier kilomètrique, la distance moyenne étant établie forfaitairement dans chaque cas.
