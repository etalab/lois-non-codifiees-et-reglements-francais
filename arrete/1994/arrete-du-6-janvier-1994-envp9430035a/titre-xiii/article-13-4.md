...
1 kg/h de métaux tels que définis à l'article 14.2.8.
...
13.4.3. Calcul de hauteur de cheminée.

On calcule d'abord la quantité s r k q/cm pour chacun des principaux polluants où :
...
la distance entre les axes des deux cheminées est inférieure à la somme : hi p hj p 10 (en mètres) ;
...
ils sont situés à une distance horizontale (exprimée en mètres) inférieure à 10 hp p 50 de l'axe de la cheminée considérée ;
...
Soit hi l'altitude (exprimée en mètres et prise par rapport au niveau moyen du sol à l'endroit de la cheminée considérée) d'un point d'un obstacle situé à une distance horizontale di (exprimée en mètres) de l'axe de la cheminée considérée, et soit Hi définie comme suit :

di $NM 2 hp p 10, Hi r hi p 5 ;

2 hp p 10 < di $NM 10 hp p 50,

Hi r 5/4 (hi p 5) [1  di/(10 hp p 50)].
