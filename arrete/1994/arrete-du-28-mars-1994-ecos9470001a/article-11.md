...
Dans le cas de mises à jour d'une sélection de notices ou notices simplifiées, le prix de l'abonnement annuel est fixé à 40 %, 50 % ou 62,5 % du prix de la sélection initiale, avec un minimum de perception de 1 400 F, 2 800 F ou 8 400 F, selon que la périodicité des mises à jour est semestrielle, trimestrielle ou mensuelle.
