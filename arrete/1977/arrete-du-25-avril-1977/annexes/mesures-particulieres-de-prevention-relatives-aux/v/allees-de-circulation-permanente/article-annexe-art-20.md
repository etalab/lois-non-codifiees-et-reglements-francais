...
La largeur des allées ne doit pas être inférieure, en sens unique, à la largeur du véhicule ou à celle du chargement, augmentée d'un mètre.
...
Les allées doivent être bordées de chaque côté et sur toute leur longueur d'un trait visible et, en outre, maintenues libres de tout obstacle.
