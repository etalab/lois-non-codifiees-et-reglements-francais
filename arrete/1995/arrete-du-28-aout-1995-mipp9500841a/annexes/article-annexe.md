...
Titulaire de l'autorisation : MCN SAT Service

Arrêté du 28 août 1995
...
La description détaillée du réseau (architecture, liste et caractéristiques techniques des stations maîtresses, fonction de gestion de groupes fermés d'utilisateurs, caractéristiques du secteur spatial, etc.) est fixée dans le cahier des clauses techniques particulières.
...
Il devra également délivrer, pour chacune des stations dépendantes raccordées au réseau, un attestation justifiant leur appartenance au réseau.
