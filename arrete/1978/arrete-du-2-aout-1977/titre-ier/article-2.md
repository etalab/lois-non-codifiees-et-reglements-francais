...
_Immeubles de la première famille_:
...
_mmeubles de la deuxième famille :_
...
_Immeubles de la troisième famille_:
...
_Immeubles de la quatrième famille_:
...
_Appareil de coupure automatique_:
...
Conduite verticale pour la plus grande partie, raccordée à la conduite d'immeuble et alimentant les différents niveaux de cet immeuble. Cette définition vise également les conduites à usage collectif placées en partie commune, sans compteur, et n'alimentant que des appareils de cuisson ;

_Débit calorifique nominal d'un appareil_:
...
_Flexible de sécurité_:

Tuyau d'alimentation en gaz d'un appareil comportant :

Dans le cas de distribution par canalisation, un tuyau flexible à embouts mécaniques et un dispositif obturateur de sécurité ; Dans le cas de distribution par récipients, un tube souple sur embouts normalisés et un dispositif obturateur de sécurité ;

_Fournisseur de gaz :_
...
_Installation à usage collectif_:
...
Dans ces limites, les distributeurs distinguent plusieurs gammes de pression : a) Pour le gaz distribué par réseau :

_Basse pression_: jusqu'à 0,05 bar inclus ;

_Moyenne pression A_: 0,05 bar à 0,4 bar inclus ;

_Moyenne pression B_: 0,4 bar à 4 bar inclus ;

b) Pour les gaz de pétrole liquéfiés distribués en récipients :

_Basse pression_: inférieure à 0,20 bar ;

_Moyenne pression_: comprise entre 0,20 et 1,75 bar ;

_Puissance utile (ou puissance nominale) d'un appareil :_

Quantité de chaleur reçue par unité de temps par le fluide chauffé ;

_Puissance calorifique totale installée_:
...
_Tuyau d'alimentation en gaz d'appareil_
...
_Complément d'une installation intérieure de gaz existante_:
...
_Mise en gaz et remise en gaz :_
...
_Modification d'installation intérieure de gaz existante_:
