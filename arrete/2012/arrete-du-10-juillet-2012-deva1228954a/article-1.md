...
― chef du bureau de l'environnement (SDD1).
...
A la mission de la coopération internationale (MCI) :
...
― chef du bureau de la performance et du pilotage budgétaire (SDF1) ;
...
― chef du domaine « gestion des ressources » (DGR).
...
― chargé de mission, conseiller auprès du directeur technique ERS (à compter du 1er juillet 2012).
...
3. A la direction de la production (MF/DP) :

― chef du département administration et ressources.

4. A la direction technique (MF/DT) :

― chef du département administration.

5. Dans les directions interrégionales de Météo-France (MF/DIR) :
...
6. A l'Ecole nationale de la météorologie (ENM) :

― secrétaire général.

7. Au Centre national de recherches météorologiques (CRNM) :

― chef de la division affaires maritimes.
