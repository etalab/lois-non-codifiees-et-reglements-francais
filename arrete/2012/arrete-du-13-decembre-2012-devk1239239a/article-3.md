...
Epreuve n° 1 : note de synthèse sur un sujet d'ordre général à partir d'un ou de plusieurs documents (durée : 3 heures ; coefficient 2).
...
Cette épreuve consiste pour le jury à apprécier la personnalité, les aptitudes du candidat, sa motivation, sa capacité à se situer dans un environnement professionnel et à s'adapter aux fonctions qui peuvent être confiées à un technicien supérieur du développement durable.
