...
SUR LE LOUP POUR LA PÉRIODE 2008-2009
...
Dans le cas où une unité d'action comprend une partie d'un parc national (hors cœur, voir ci-dessous), l'arrêté préfectoral définissant les unités d'action précise que ces zones sont situées dans un parc national.
...
des opérations d'effarouchement et de destruction
