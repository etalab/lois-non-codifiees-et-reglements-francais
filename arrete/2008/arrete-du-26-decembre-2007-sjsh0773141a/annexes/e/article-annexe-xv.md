...
Les comptes de la santé (approche macroéconomique) :
...
L'aide à la décision dans le domaine de la santé (approche micro-économique) : principes et méthodologie de l'évaluation économique (calcul des coûts/indicateurs de résultats médico-économiques/pilotage de la performance) ; exemples d'application.
...
Les limites d'analyse et les principaux biais (critiques de l'information).
