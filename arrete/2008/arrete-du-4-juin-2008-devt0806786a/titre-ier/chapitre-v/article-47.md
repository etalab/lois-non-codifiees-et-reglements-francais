...
_Zone d'accès restreint temporaire_. ― Une zone d'accès restreint temporaire peut être créée par le représentant de l'Etat dans le département, selon les modalités fixées à l'article R. 321-31 du code des ports maritimes, pour une durée limitée ne pouvant dépasser deux mois.
