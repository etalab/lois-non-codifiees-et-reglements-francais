...
Les données à caractère personnel utilisées par ce traitement sont issues de la liste électorale arrêtée pour les précédentes élections, actualisées avec les données fournies par la direction des affaires maritimes (DAM), les données relatives aux permis de pêche à pied fournies par les directions départementales, interdépartementales et interrégionales de la mer et les données de la base de données nationale des usagers du ministère de l'agriculture (BDNU).
