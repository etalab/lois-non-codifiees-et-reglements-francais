...
4. Pour les navires non adhérents à une organisation de producteurs, les demandes sont classées par ordre d'éligibilité en fonction des captures effectuées en 2009 et/ou 2010, dans le respect des taux de captures annuels et du plafond de capacité. Pour les navires adhérents à une organisation de producteurs, les demandes sont classées par ordre d'éligibilité en fonction de la répartition du quota communiquée par l'organisation de producteurs d'adhésion, dans le respect des taux de captures annuels et du plafond de capacité.
...
6. A compter de 2012, la réattribution du PPS thon rouge pour la mer Méditerranée, option canneur ligneur palangrier, prendra en considération la réalité de la pêche de thon rouge effectuée au cours de l'année précédente.
