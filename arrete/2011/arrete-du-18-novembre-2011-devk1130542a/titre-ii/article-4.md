...
1 : superviseur des bureaux sécurité marchandises dangereuses et vracs ;

1 : écluse François-Ier ;
...
Nantes - Saint-Nazaire : 11 postes :

6 : chef de quart vigie ;

3 : matières dangereuses, sécurité ;

1 : responsable intervention du secteur aval ;

1 : responsable intervention du secteur amont.
...
1 : responsable Rives - Honfleur/Radicatel.
