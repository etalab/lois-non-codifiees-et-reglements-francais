...
I. ― Pour chaque période bimestrielle, l'établissement de santé transmet à l'agence régionale de santé les fichiers de données mentionnés à l'article 5. Ces fichiers sont issus de la plus récente version des programmes informatiques générateurs de RHA et de RSFA. La transmission s'effectue par une méthode de télétransmission agréée par les services de l'Etat. Ces fichiers de données cumulatives à périodicité de transmission bimestrielle sont relatifs aux résumés, d'une part, du bimestre écoulé et, d'autre part, du ou des bimestres précédents de la même année civile. Ils sont transmis deux mois au plus tard après la fin du bimestre concerné.
...
IV. ― Pour chaque établissement de santé, le médecin chargé de l'information médicale est responsable de la sauvegarde des fichiers de RHS groupés, de résumés standardisés de facturation (RSF) et de FICHCOMP, qui sont à l'origine des fichiers de RHA, de SSRHA, de RSFA et de FICHCOMPA ainsi que de la conservation de la copie produite pour une durée de cinq ans.
