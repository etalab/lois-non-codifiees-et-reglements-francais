...
La validation finale comprend les épreuves suivantes :

Deux épreuves techniques, dont la moyenne est affectée d'un coefficient 3 :
...
Un mémoire (coefficient 1) et sa soutenance (coefficient 2) devant un jury dont la composition est fixée à l'article 7. Le mémoire devra porter sur la définition ou la conduite d'un projet de prise en charge sous tous ses aspects, sous l'angle d'une fonction de direction.
