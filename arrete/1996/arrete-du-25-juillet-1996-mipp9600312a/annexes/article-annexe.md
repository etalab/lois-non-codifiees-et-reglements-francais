...
CAHIER DES CHARGES RELATIF À L'AUTORISATION D'UN RÉSEAU INDÉPENDANT DE TÉLÉCOMMUNICATIONS PAR SATELLITES

Titulaire de l'autorisation : Métropole Télévision
...
Ce terme englobe l'ensemble des infrastructures utilisées par l'exploitant (secteur spatial, stations autonomes, stations maîtresses ainsi que les stations dépendantes des clients qui y sont raccordées).
...
La description détaillée du réseau (architecture, liste et caractéristiques techniques des stations maîtresses et des stations autonomes ainsi que leurs conditions d'exploitation, fonctions de gestion de groupes fermés d'utilisateurs, caractéristiques du secteur spatial, etc.) est fixée dans le cahier des clauses techniques particulières.
...
A titre exceptionnel, et jusqu'à la mise en place de la procédure d'agrément, le titulaire pourra installer et exploiter les stations dépendantes nécessaires à la fourniture du service. Le titulaire devra s'assurer que les demandes d'agrément des stations utilisées dans son réseau auront été déposées dans les deux mois qui suivront la mise en place de la procédure d'agrément. Les stations agréées devront faire l'objet d'un marquage conforme à la réglementation. Les stations qui n'auraient pas reçu l'agrément devront être remplacées par des modèles agréés.
