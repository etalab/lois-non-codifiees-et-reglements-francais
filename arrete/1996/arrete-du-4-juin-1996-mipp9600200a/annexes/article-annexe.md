...
Titulaire de l'autorisation : Start
...
Les stations de réception utilisées dans le réseau doivent faire l'objet d'une déclaration par leur fabricant ou leur fournisseur, auprès de la direction générale des postes et télécommunications, attestant de leur conformité aux exigences de protection du spectre radioélectrique.
...
A titre exceptionnel, et jusqu'à la mise en place des procédures nationales de déclaration et d'agrément, le titulaire pourra installer et exploiter les stations de réception nécessaires à la fourniture du service. Le titulaire devra s'assurer que les déclarations concernant les stations utilisées dans son réseau, ainsi que les demandes d'agrément dans le cas de connexion au réseau ouvert au public, auront été déposées dans les deux mois qui suivront la mise en place des procédures nationales de déclaration et d'agrément.
...
2.4.1. Connexion au réseau public
