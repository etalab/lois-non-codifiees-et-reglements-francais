...
Titulaire de l'autorisation : Compagnie financière et industrielle des autoroutes (Cofiroute).
...
Il désigne la Compagnie financière et industrielle des autoroutes (Cofiroute).

1.2. Le réseau

Ce terme englobe l'ensemble des infrastructures, câbles et faisceaux hertziens, établies et exploitées par le titulaire. Les autres moyens de transmission radioélectrique ne sont pas inclus.
...
Les divers systèmes de télécommunications constituant le réseau et utilisant les supports de transmission fibres optiques, paires symétriques, câbles coaxiaux ou faisceaux hertziens, sont décrits dans le Cahier des clauses techniques particulières (C.C.T.P.), annexé au présent arrêté.
...
Toute connexion avec d'autres réseaux indépendants est soumise à l'accord préalable du directeur général des postes et des télécommunications du ministère chargé des télécommunications.
...
2.4.3. Interconnexions destinées à permettre l'accès

de tiers au réseau

Le réseau du titulaire peut être interconnecté avec le réseau public afin de permettre aux entités utilisatrices de communiquer avec des tiers ; ces interconnexions interviennent dans les conditions ci-après.

L'acheminement des communications en provenance ou à destination d'un équipement terminal raccordé à un point de terminaison du réseau du titulaire s'effectue à un point de connexion avec le réseau public situé dans la même circonscription tarifaire ou dans les circonscriptions contiguës à celle dudit point de terminaison, dans les conditions fixées par le C.C.T.P.

2.4.4. Interconnexions avec d'autres réseaux indépendants

Le réseau du titulaire peut être interconnecté avec un ou plusieurs réseaux indépendants afin de permettre la communication avec des tiers identifiés, pour des relations se rapportant directement à leur intérêts communs, tels que l'exploitation autoroutière, l'information et la sécurité des utilisateurs des réseaux autoroutiers. La localisation ainsi que la capacité des points de connexion à ces autres réseaux indépendants sont fixées au C.C.T.P.
...
Les équipements terminaux raccordés au réseau doivent être agréés dès lors qu'ils sont connectés soit directement à un réseau ouvert au public, soit indirectement et qu'ils assurent le service de téléphonie vocale de bout en bout.
...
L'exploitant n'est pas autorisé à exploiter le fichier des abonnés d'autres fins que celles caractérisant le traitement soumis à la C.N.I.L. en application de la loi susvisée.
...
La durée de l'autorisation est fixée à dix ans à partir de la date de publication de l'arrêté d'autorisation. Au plus tard six mois avant la date d'expiration de l'autorisation, le titulaire fait connaître son souhait de la renouveler, dans des conditions et dans des termes qui seront, alors, à définir.
