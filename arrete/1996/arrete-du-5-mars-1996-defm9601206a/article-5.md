...
Pour l'application du présent arrêté, le contrôle des frais de production est effectué en fin d'exécution de chaque prestation ou groupe de prestations des marchés ou d'un programme visés à l'article 2, en utilisant directement le système de comptabilité générale et de comptabilité analytique d'exploitation de l'entreprise, ainsi que ses méthodes d'enregistrement des coûts et de suivi des affaires, tel que celui-ci est pratiqué à l'intérieur de l'entreprise par les responsables de ces affaires.
