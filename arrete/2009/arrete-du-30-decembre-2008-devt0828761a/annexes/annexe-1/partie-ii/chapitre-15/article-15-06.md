...
Bateaux à excursions journalières : A<sub>R</sub> = 0,35 . F<sub>max</sub> [m<sup>2</sup>]

Bateaux à cabines : A<sub>R</sub> = 0,45 . F<sub>max</sub> [m<sup>2</sup>]

Dans ces formules :

F<sub>max</sub> = nombre maximal de passagers admissibles à bord.

b) Chaque aire de rassemblement ou d'évacuation doit avoir une surface supérieure à 0 m<sup>2</sup>.
