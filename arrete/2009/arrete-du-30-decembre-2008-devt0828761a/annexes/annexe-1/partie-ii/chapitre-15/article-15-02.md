...
t <sub>1min</sub> = 0,006.a.√T [mm] ;

t <sub>2min</sub> = f.0,55.√L<sub>F</sub> [mm].
...
3. La distance de la cloison d'abordage à la perpendiculaire avant doit être au moins égale à 0,04 L<sub>F</sub> sans toutefois dépasser 0,04 L<sub>F</sub> + 2 m.
