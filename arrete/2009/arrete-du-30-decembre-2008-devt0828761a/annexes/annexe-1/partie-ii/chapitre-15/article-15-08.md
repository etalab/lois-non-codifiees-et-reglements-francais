...
8. Si des parties d'installations de distribution de CO<sub>2</sub> sont présentes dans des locaux situés sous le pont, celles-ci doivent être équipées d'une installation de ventilation qui se met en fonction automatiquement à l'ouverture de la porte ou de l'écoutille d'un tel local. Les conduites de ventilation doivent aboutir à 0,05 m du sol de ce local.
