...
Si, pour l'attribution d'un siège, des listes ont la même moyenne, ledit siège est attribué à la liste qui a recueilli le plus grand nombre de voix. Si plusieurs de ces listes ont obtenu le même nombre de voix, le siège est attribué à l'une d'entre elles par voie de tirage au sort.
