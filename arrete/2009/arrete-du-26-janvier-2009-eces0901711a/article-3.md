...
Les coordonnées des personnes (noms, prénoms, adresses) seront saisies et conservées pendant cinq ans, dans un fichier distinct de celui contenant les données collectées.
