...
A défaut de rectification, si un ou plusieurs candidats inscrits sur une liste sont reconnus inéligibles, la liste intéressée est considérée comme n'ayant présenté aucun candidat pour la ou les catégories d'emploi correspondantes.
...
Les listes établies dans les conditions fixées par le présent arrêté sont affichées dès que possible sur l'ensemble des sites de l'établissement.
