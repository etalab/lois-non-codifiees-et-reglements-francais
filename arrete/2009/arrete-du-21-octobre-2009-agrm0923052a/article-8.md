...
Ce plan collectif est établi conjointement, d'une part, soit par les organisations de producteurs, soit par le comité local des pêches maritimes, qui fixent un roulement des armements, et, d'autre part, par le syndicat local des mareyeurs. Ce plan collectif est transmis aux DRAM et aux DDAM, qui sont informées des arrêts effectués.
