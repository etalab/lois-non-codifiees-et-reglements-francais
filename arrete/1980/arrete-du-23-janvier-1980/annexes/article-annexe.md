...
L'avitaillement des hélicoptères sur les hélistations autorisées sur le toit des immeubles est formellement interdit.
...
Lorsque du CO<sup>2</sup> ou des halons seront utilisés, les équivalences avec la poudre seront :

1 kg de poudre = 1 kg de halons ;

1 kg de poudre = 2 kg de CO<sup>2</sup>.
