...
L'accès à la classe de première de la série « sciences et technologies du design et des arts appliqués (STD2A) » est ouvert aux élèves qui s'orientent dans cette série à l'issue de la classe de seconde générale et technologique. Cet accès ne peut en aucun cas être soumis à la condition d'avoir suivi un enseignement d'exploration particulier en classe de seconde.
