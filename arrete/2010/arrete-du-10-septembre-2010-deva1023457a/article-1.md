...
9. A la mission de la coopération internationale :
...
4. A la sous-direction des systèmes d'information et de la modernisation (SDSIM) :
...
2. A la direction des ressources humaines (DRH) :
...
5. Dans les directions interrégionales de Météo-France (DIR) :
...
7. Au Centre national de recherches météorologiques (CNRM) ;
