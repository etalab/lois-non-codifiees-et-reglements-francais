...
3. Les micro-ordinateurs utilisés pour l'installation radioélectrique doivent être réservés exclusivement aux radiocommunications, protégés des micro-coupures et munis de dispositifs anti-virus efficaces. La défaillance d'un système centralisé de gestion, s'il existe, ne doit pas avoir pour effet d'empêcher l'envoi etla réception des messages de détresse.
