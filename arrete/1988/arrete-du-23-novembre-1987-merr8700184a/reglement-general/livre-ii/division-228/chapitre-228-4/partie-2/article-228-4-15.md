...
De plus, si l'agent réfrigérant utilisé est l'ammoniac :
...
- un ensemble combinaison et appareil respiratoire distinct de ceux prévus au présent paragraphe en vue de la protection contre l'ammoniac doit être situé dans un endroit facilement accessible et à proximité de l'un des moyens d'accès aux locaux contenant les machines, appareils et circuits d'ammoniac. Il doit permettre à un membre du personnel d'y pénétrer rapidement et sans danger.
...
7.1. Prescription particulière aux installations de conditionnement d'air :
