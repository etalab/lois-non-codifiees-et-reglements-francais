...
3 La (les) personne(s) responsable(s) du chargement des marchandises dangereuses dans un engin de transport (19) doit (doivent) fournir un certificat d'empotage de conteneur/de véhicule signé, attestant que la marchandise se trouvant dans l'engin a été correctement chargée et assujettie et qu'il a été satisfait à toutes les prescriptions applicables en matière de transport. Ce certificat peut faire partie du document mentionné au paragraphe 2.
