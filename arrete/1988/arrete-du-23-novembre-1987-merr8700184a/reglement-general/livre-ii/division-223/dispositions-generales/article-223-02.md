...
2.2. Classe B : navire à passagers effectuant des voyages nationaux au cours desquels il ne se trouve jamais à plus de 20 milles de la côte, où des personnes naufragées peuvent gagner la terre avec une hauteur de marée de coefficient moyen.

2.3. Classe C : navire à passagers effectuant des voyages nationaux dans des zones maritimes où, au cours d'une période d'un an dans le cas d'une exploitation s'étendant sur toute l'année et d'une période spécifique de l'année dans le cas d'une exploitation limitée à cette période (par exemple : exploitation estivale), la probabilité de rencontrer des vagues d'une hauteur significative supérieure à 2,5 mètres est inférieure à 10%, le navire ne se trouvant jamais à plus de 15 milles d'un refuge ni à plus de 5 milles de la côte , où des personnes naufragées peuvent gagner la terre avec une hauteur de marée de coefficient moyen.

2.4. Classe D : navire à passagers effectuant des voyages nationaux dans des zones maritimes où, au cours d'une période d'un an dans le cas d'une exploitation s'étendant sur toute l'année et d'une période spécifique de l'année dans le cas d'une exploitation limitée à cette période (par exemple : exploitation estivale), la probabilité de rencontrer des vagues d'une hauteur significative supérieure à 1,5 mètres est inférieure à 10 %, le navire ne se trouvant jamais à plus de 6 milles d'un refuge ni à plus de 3 milles de la côte , où des personnes naufragées peuvent gagner la terre avec une hauteur de marée de coefficient moyen.
...
b) Publie cette liste dans une base de données publique consultable sur le site Internet de l'autorité maritime compétente (1) ;
