...
2. Les bouteilles d'oxycoupage et leur détendeur doivent être placés sur un pont découvert. Les canalisations fixes, si elles existent, doivent être métalliques, comporter le moins possible de raccords et être éprouvées conformément aux dispositions de l'article 226-3.27 (paragraphe 3) ci-dessus.
...
Une consigne écrite doit être affichée au poste d'utilisation sur la nécessité de refermer les bouteilles après usage.
