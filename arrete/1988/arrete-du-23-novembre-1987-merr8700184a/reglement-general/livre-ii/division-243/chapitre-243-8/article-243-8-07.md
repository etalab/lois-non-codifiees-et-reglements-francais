...
III. - Lorsqu'une source d'énergie de réserve est constituée d'une ou de plusieurs batteries d'accumulateurs rechargeables, un moyen de recharger automatiquement ces batteries est prévu. Il doit être capable de les recharger jusqu'à la capacité minimale requise dans un délai de 10 heures.

IV. - Les batteries d'accumulateurs qui constituent une source d'énergie de réserve sont placées et installées de manière à assurer leur protection en exploitation courante. Au minimum, elle sont placées dans des emplacements à l'abri des intempéries.
