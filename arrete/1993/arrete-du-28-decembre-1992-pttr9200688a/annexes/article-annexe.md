...
RELATIF À L'AUTORISATION D'EXPLOITATION D'UN RÉSEAU

INDÉPENDANT DE TÉLÉCOMMUNICATIONS PAR SATELLITES

Titulaire de l'autorisation : Overseas Telecommunications Inc.
...
Il s'agit d'une des personnes (morales en général) qui souscrivent auprès de l'exploitant un abonnement à l'un ou à plusieurs des services qu'il propose.
