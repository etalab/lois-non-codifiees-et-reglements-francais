...
2° La partie qui a effectué la première étape de la procédure délivre pour chacun des instruments un certificat contenant les données nécessaires à l'identification de l'instrument et spécifiant les examens et essais qui ont été effectués.
