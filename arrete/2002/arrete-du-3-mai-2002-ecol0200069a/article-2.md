...
I. - Les informations transmises à la CNAF sont exclusivement utilisées par les caisses d'allocations familiales pour engager une procédure de contrôle a posteriori des ressources, pour l'année N-1, des ménages bénéficiant pendant l'année N d'une ou plusieurs des prestations servies sous condition de ressources citées ci-après :

l'aide personnalisée au logement (APL), l'allocation de logement à caractère social (ALS), l'allocation de logement à caractère familial (ALF), la prime de déménagement, l'allocation aux adultes handicapés (AAH), le complément familial (CF), l'allocation pour jeune enfant (APJE), l'allocation d'adoption, l'allocation de rentrée scolaire (ARS), l'allocation de garde d'enfant à domicile (AGED), l'aide à la famille pour l'emploi d'une assistante maternelle agréée (AFEAMA), la prestation pour l'accueil du jeune enfant (PAJE).
