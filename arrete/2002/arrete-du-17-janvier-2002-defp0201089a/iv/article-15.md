...
L'épreuve orale d'anglais comprend deux exercices répartis sur 1 heure :

Durant les 40 premières minutes :

- le candidat est soumis à un test de compréhension consistant en l'audition, au maximum 3 fois, d'un texte enregistré en anglais, d'une durée de 3 minutes environ ; il en effectue un résumé oral en anglais ;
