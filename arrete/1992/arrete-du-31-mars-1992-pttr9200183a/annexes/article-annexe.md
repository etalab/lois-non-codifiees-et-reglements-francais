...
CAHIER DES CHARGES RELATIF À L'AUTORISATION D'EXPLOITATION DE RÉSEAUX INDÉPENDANTS DE TÉLÉCOMMUNICATIONS PAR SATELLITES

Titulaire de l'autorisation : Deutsche Bundespost Telekom
...
Il s'agit de la Deutsche Bundespost Telekom, autorisée par le ministre chargé des télécommunications par l'arrêté dont ce cahier des charges est l'annexe, à exploiter des réseaux indépendants unidirectionnel et bidirectionnel par satellites pour le compte de groupes fermés d'utilisateurs et à installer sur le territoire national les stations nécessaires à la fourniture des services supportés par ce réseau.
...
Il s'agit d'un document auquel se réfère le présent cahier des charges, qui précise les points techniques spécifiques. Ce document fait l'objet d'une mise à jour au moins annuelle tout au long de la période d'autorisation. Un cahier des clauses techniques particulières est établi pour chacun des deux types de réseau :
...
L'arrêté dont le présent cahier des charges est l'annexe autorise la Deutsche Bundespost Telekom à exploiter des réseaux indépendants de télécommunications unidirectionnel et bidirectionnel par satellites pour des groupes fermés d'utilisateurs.

L'autorisation comprend l'autorisation d'exploiter des services internationaux sur ledit réseau et d'installer et d'exploiter les stations dépendantes nécessaires sur le territoire national. L'installation et l'exploitation de stations en dehors du territoire national sont assujetties à la réglementation en vigueur dans chacun des pays concernés.
...
La description détaillée du réseau (architecture, liste et caractéristiques techniques des stations maîtresses, fonctions de gestion de groupes fermés d'utilisateurs, caractéristiques du secteur spatial, etc.) est fixée dans le cahier des clauses techniques particulières correspondant.
...
A titre exceptionnel, et jusqu'à la publication de ces spécifications, le titulaire pourra installer et exploiter les stations dépendantes nécessaires à la fourniture du service. Le titulaire devra s'assurer que les demandes d'agrément des stations utilisées dans son réseau auront été déposées dans les deux mois qui suivront la publication des spécifications. Les stations agréées devront faire l'objet d'un marquage conforme à la réglementation. Les stations agréées devront faire l'objet d'un marquage conforme à la réglementation. Les stations qui n'auraient pas reçu l'agrément devront être remplacées par des modèles agréés.
...
Conformément à l'article L. 34-9 du code des postes et télécommunications, seuls les installateurs qualifiés en radiocommunications peuvent raccorder, mettre en service et entretenir les stations dépendantes présentant des fonctions d'émission.

2.5. Connexion avec d'autres réseaux

2.5.1. Connexion au réseau public

Le réseau objet de la présente autorisation peuvent être connectés au réseau public dans les conditions définies aux paragraphes a et b ci-après. La liste et les caractéristiques (en particulier pour la gestion des groupes fermés d'utilisateurs) des points de connexion du réseau objet de la présente autorisation au réseau public, sont décrites dans les C.C.T.P.

a) Interconnexions destinées à relier entre eux les membres d'un groupe fermé d'utilisateurs :

Il s'agit d'interconnexions avec le réseau public effectuées dans le strict respect de l'exploitation du réseau pour d'un groupe fermé d'utilisateurs.
...
Le titulaire doit acquitter pour chaque type de réseau une contribution pour frais de dossier ainsi qu'une contribution annuelle pour frais de gestion, selon les modalités fixées par les textes tarifaires en vigueur.
