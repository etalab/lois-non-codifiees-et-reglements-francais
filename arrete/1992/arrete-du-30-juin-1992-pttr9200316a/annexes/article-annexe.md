...
RELATIF A L'AUTORISATION D'EXPLOITATION D'UN RÉSEAU
...
Il s'agit des stations terriennes des utilisateurs, qui ne peuvent recevoir des informations que sur ordre de l'unité de contrôle du réseau.
...
L'arrêté dont le présent cahier des charges est l'annexe autorise la société Segif à exploiter un réseau indépendant unidirectionnel de télécommunications par satellites pour des groupes fermés d'utilisateurs.
...
Les stations de réceptions utilisées dans le réseau doivent faire l'objet d'une déclaration par leur fabricant ou leur fournisseur auprès de la direction de la réglementation générale attestant de leur conformité aux exigences de protection du spectre radioélectrique.
