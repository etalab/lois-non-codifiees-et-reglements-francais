...
Le dimanche ou un jour férié, le tarif prévu en A et B peut être majoré de 25 %.
...
Il s'applique à la totalité de la facture, et donc aussi bien au poste de facturation "Forfait départemental ou minimum de perception" qu'au poste "Tarif kilométrique départemental", majorée éventuellement soit pour transport de nuit, soit pour transport le dimanche ou un jour férié.

Remarque :

Lorsqu'un véhicule effectue un transport comportant l'aller et le retour du malade, deux courses sont facturables.
