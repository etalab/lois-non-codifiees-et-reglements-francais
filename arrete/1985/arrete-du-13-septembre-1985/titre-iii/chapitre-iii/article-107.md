...
(Modalités d'enregistrement des paris). - Après être entré en communication avec le serveur vocal interactif du pari mutuel urbain, le parieur devra s'authentifier préalablement à toutes opérations sur son compte courant, selon les procédures indiquées par le serveur.
