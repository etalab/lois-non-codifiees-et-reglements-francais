...
Un supplément de 103,30 F peut être perçu, sur présentation d'un justificatif, pour un transport d'urgence effectué sur la demande expresse d'un médecin régulateur (centre 15), d'un service d'aide médicale d'urgence (SAMU) ou sur appel des services mobiles d'urgence et de réanimation (SMUR) lorsque ni le SAMU ni le centre 15 n'existent dans le département. La demande formulée dans les conditions prévues ci-dessus peut parvenir à l'ambulancier soit directement, soit par l'intermédiaire d'une association de transports sanitaires d'urgence.
