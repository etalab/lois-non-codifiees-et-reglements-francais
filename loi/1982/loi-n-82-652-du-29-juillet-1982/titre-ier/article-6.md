...
La demande d'exercice du droit de réponse doit être présentée dans les huit jours suivant celui de la diffusion du message contenant l'imputation qui la fonde [*délai*].
