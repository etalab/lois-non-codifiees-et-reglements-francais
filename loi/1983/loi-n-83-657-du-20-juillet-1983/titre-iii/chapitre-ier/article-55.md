...
2° Selon des modalités prévues par les statuts, le nombre de voix dont dispose chaque société coopérative peut être proportionnel au montant des opérations réalisées par elle avec l'union ou au nombre de ses associés. Le rapport entre le nombre de voix détenues par deux coopératives ne peut excéder trois [*droit de vote*].
