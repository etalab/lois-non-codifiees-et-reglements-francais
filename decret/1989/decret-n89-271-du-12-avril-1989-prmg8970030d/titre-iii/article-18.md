...
Le changement de résidence [*définition*] est celui que l'agent se trouve dans l'obligation d'effectuer lorsqu'il reçoit une affectation définitive dans une commune différente de celle dans laquelle il était affecté antérieurement.
