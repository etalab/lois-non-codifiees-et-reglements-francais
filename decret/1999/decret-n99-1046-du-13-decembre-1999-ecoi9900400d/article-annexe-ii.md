...
###<font size="1">Procédures d'évaluation de conformité</font>
...
#####<font size="1">Module A 1 : (contrôle interne de la fabrication avec surveillance de la vérification finale)</font>
...
- procéder au prélèvement sur les lieux de fabrication ou d'entreposage d'équipements sous pression à des fins de contrôle. L'organisme habilité apprécie le nombre d'équipements à prélever ainsi que la nécessité d'effectuer ou de faire effectuer sur ces équipements sous pression prélevés tout ou partie de la vérification finale.
...
#####<font size="1">Module B : (examen "CE de type")</font>
...
**8.**Les autres organismes habilités peuvent obtenir copie des attestations d'examen CE de type et/ou de leurs compléments. Les annexes des attestations sont tenues à la disposition des autres organismes habilités.
...
#####<font size="1">Module B 1 : (examen CE de la conception)</font>
...
#####<font size="1">Module C 1 : (conformité au type)</font>
...
#####<font size="1">Module D : (assurance qualité production)</font>
...
#####<font size="1">Module D 1 : (Assurance qualité production)</font>
...
- une liste des nomes visées à l'article 6, appliquées en tout ou en partie, et les descriptions des solutions retenues pour satisfaire aux exigences essentielles de la directive lorsque les normes visées à l'article 6 n'ont pas été appliquées ;
...
#####<font size="1">Module E : (assurance qualité produits)</font>
...
#####<font size="1">Module E 1 : (assurance qualité produits)</font>
...
#####<font size="1">Module F : (vérification sur produits)</font>
...
- vérifie que le personnel pour l'assemblage permanent des pièces et les essais non destructifs est qualifié ou approuvé conformément aux points 3.1.2 et 3.1.3 del'annexe 1 ;

- vérifie le certificat délivré par le fabricant de matériau conformément au point 4.3 de l'annexe 1 ;
...
#####<font size="1">Module G : (vérification CE à l'unité)</font>
...
#####<font size="1">Module H : (assurance complète de qualité)</font>
...
######<font size="1">
<b>3.3.</b> L'organisme habilité évalue le système de qualité en vue de déterminer s'il répond aux exigences visées au point 3.2. Les éléments du système de qualité conformes à la norme harmonisé pertinente sont présumés conformes aux exigences correspondantes visées au point 3.2.</font>
...
**6.**Chaque organise habilité communique aux Etats membres les informations utiles concernant les approbations de systèmes de qualité qu'il a retirées et, sur demande, celles qu'il a délivrées.
...
#####<font size="1">Module H 1 : (assurance qualité complète avec contrôle de la conception et surveillance particulière de la vérification finale)</font>
...
b) La demande doit permettre de comprendre la conception, la fabrication et le fonctionnement de l'équipement sous pression et d'évaluer sa conformité avec les exigences correspondantes de la directive ;
