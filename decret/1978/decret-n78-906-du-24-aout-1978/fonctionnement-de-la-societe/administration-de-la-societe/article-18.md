...
Toutefois, lorsque les associés n'exercent qu'à temps partiel, les statuts [*contenu*] pourront leur attribuer un nombre de voix réduit.

Un associé peut donner mandat écrit à un autre associé de le représenter à l'assemblée [*procuration*]. Un associé ne peut être porteur de plus de deux mandats.
