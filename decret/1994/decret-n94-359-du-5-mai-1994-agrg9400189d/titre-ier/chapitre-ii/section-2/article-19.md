...
a) Les informations destinées à justifier une extension d'emploi ont été fournies par le demandeur ;

b) Les conditions d'efficacité et d'innocuité sont remplies ;

c) L'utilisation envisagée présente un caractère mineur ;

d) Une information complète et spécifique des utilisateurs est assurée, en ce qui concerne le mode d'emploi, soit par des indications complémentaires apposées sur l'étiquette, soit par une publication officielle.
