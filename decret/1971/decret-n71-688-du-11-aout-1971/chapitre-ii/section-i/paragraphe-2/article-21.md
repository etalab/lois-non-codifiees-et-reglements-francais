...
Chaque associé dispose d'une seule voix [*droit de vote*.

Un associé peut se faire représenter à une assemblée par un autre associé porteur d'un mandat écrit *]procuration*.
