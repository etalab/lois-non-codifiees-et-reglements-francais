...
Pour prétendre à l'allocation de préretraite, le chef d'exploitation doit [*condition d'obtention*] :
...
Une modification du statut de l'exploitation notamment par transformation en co-exploitation ou constitution d'une société.
