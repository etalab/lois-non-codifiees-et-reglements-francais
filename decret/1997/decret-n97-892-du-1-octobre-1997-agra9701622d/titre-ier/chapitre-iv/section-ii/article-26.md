...
Les agents non titulaires sont classés dans le grade d'attaché à un échelon qui est déterminé en prenant en compte, sur la base des durées moyennes fixées à l'article 32 ci-dessous pour chaque avancement d'échelon, une fraction de leur ancienneté de services dans les conditions suivantes :
